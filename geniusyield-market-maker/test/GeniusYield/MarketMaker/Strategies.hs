...
type Strategy = PPStatus -> PricesProviders -> User -> MMToken -> IO (UserActions, UserActionsController)
...
fixedSpreadVsMarketPriceStrategy
  ...
  mmToken = do
    ...
    flip5 withPriceEstimate ppStatus pp user mmToken $ \mp -> do
